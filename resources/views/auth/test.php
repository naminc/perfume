...
<head>
	...
	<title>Stelina - Login</title>
	<link rel="canonical" href="https://dreamingtheme.kiendaotac.com/html/stelina/login.html" />
	<meta http-equiv="X-UA-compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="shortcut icon" type="image/x-icon" href="../../html/stelina/assets/images/favicon.png"/>
	<link href="https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="../../html/stelina/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/font-awesome.min.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/owl.carousel.min.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/animate.min.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/jquery-ui.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/slick.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/chosen.min.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/pe-icon-7-stroke.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/magnific-popup.min.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/lightbox.min.css">
	<link rel="stylesheet" href="../../html/stelina/assets/js/fancybox/source/jquery.fancybox.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/jquery.scrollbar.min.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/mobile-menu.css">
	<link rel="stylesheet" href="../../html/stelina/assets/fonts/flaticon/flaticon.css">
	<link rel="stylesheet" href="../../html/stelina/assets/css/style.css">
</head>
			...
			<div class="container">
				...
				<div class="top-bar-right">
					...
					<ul class="header-user-links">
						<li>
							<a href="../../html/stelina/login.html">Login or Register</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="main-header">
				<div class="row">
					<div class="col-lg-3 col-sm-4 col-md-3 col-xs-7 col-ts-12 header-element">
						<div class="logo">
							<a href="../../index.html">
								<img src="../../html/stelina/assets/images/logo.png" alt="img">
							</a>
						</div>
					</div>
							...
							<ul class="stelina-clone-mobile-menu stelina-nav main-menu " id="menu-main-menu">
								<li class="menu-item  menu-item-has-children">
									...
									<ul class="submenu">
										...
										<li class="menu-item">
											<a href="../../html/stelina/home2.html">Home 02</a>
										</li>
										<li class="menu-item">
											<a href="../../html/stelina/home3.html">Home 03</a>
										</li>
									</ul>
								</li>
								<li class="menu-item menu-item-has-children">
									<a href="../../html/stelina/gridproducts.html" class="stelina-menu-item-title" title="Shop">Shop</a>
									<span class="toggle-submenu"></span>
									<ul class="submenu">
										<li class="menu-item">
											<a href="../../html/stelina/gridproducts.html">Grid Fullwidth</a>
										</li>
										<li class="menu-item">
											<a href="../../html/stelina/gridproducts_leftsidebar.html">Grid Left sidebar</a>
										</li>
										<li class="menu-item">
											<a href="../../html/stelina/gridproducts_bannerslider.html">Grid Bannerslider</a>
										</li>
										<li class="menu-item">
											<a href="../../html/stelina/listproducts.html">List</a>
										</li>
									</ul>
								</li>
										...
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 menu-page-item">
												<div class="stelina-custommenu default">
													...
													<ul class="menu">
														<li class="menu-item">
															<a href="../../html/stelina/shoppingcart.html">Shopping Cart</a>
														</li>
														<li class="menu-item">
															<a href="../../html/stelina/checkout.html">Checkout</a>
														</li>
														<li class="menu-item">
															<a href="../../html/stelina/contact.html">Contact us</a>
														</li>
														<li class="menu-item">
															<a href="../../html/stelina/404page.html">404</a>
														</li>
														<li class="menu-item">
															<a href="../../html/stelina/login.html">Login/Register</a>
														</li>
													</ul>
												</div>
											</div>
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 menu-page-item">
												<div class="stelina-custommenu default">
													...
													<ul class="menu">
														<li class="menu-item">
															<a href="../../html/stelina/productdetails-fullwidth.html">Product Fullwidth</a>
														</li>
														<li class="menu-item">
															<a href="../../html/stelina/productdetails-leftsidebar.html">Product left sidebar</a>
														</li>
														<li class="menu-item">
															<a href="../../html/stelina/productdetails-rightsidebar.html">Product right sidebar</a>
														</li>
													</ul>
												</div>
											</div>
								...
								<li class="menu-item  menu-item-has-children">
									<a href="../../html/stelina/inblog_right-siderbar.html" class="stelina-menu-item-title"
									   title="Blogs">Blogs</a>
									<span class="toggle-submenu"></span>
									<ul class="submenu">
										<li class="menu-item menu-item-has-children">
											...
											<ul class="submenu">
												<li class="menu-item">
													<a href="../../html/stelina/bloggrid.html">Grid</a>
												</li>
												<li class="menu-item">
													<a href="../../html/stelina/bloglist.html">List</a>
												</li>
												<li class="menu-item">
													<a href="../../html/stelina/bloglist-leftsidebar.html">List Sidebar</a>
												</li>
											</ul>
										</li>
										<li class="menu-item menu-item-has-children">
											...
											<ul class="submenu">
												<li class="menu-item">
													<a href="../../html/stelina/inblog_left-siderbar.html">Left Sidebar</a>
												</li>
												<li class="menu-item">
													<a href="../../html/stelina/inblog_right-siderbar.html">Right Sidebar</a>
												</li>
											</ul>
										</li>
									</ul>
								...
								<li class="menu-item">
									<a href="../../html/stelina/about.html" class="stelina-menu-item-title" title="About">About</a>
								</li>
							</ul>
						</div>
					</div>
