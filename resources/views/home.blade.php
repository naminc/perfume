          ...
          <div class="slider-item style1">
            <div class="slider-inner equal-element">
              <div class="slider-infor">
                ...
                <h3 class="title-big">Scandinavians
                  <br/>Collection</h3>
              ...
              <div class="item-banner style12">
                <div class="inner">
                  <div class="banner-content">
                    ...
                    <div class="description">Check out our your
                      <br/>perfume collection now!</div>
                    <a href="#" class="button btn-shop-now">Shop now</a>
                  </div>
                </div>
              </div>
              ...
              <div class="item-banner style12 type2">
                <div class="inner">
                  <div class="banner-content">
                    ...
                    <div class="description">New Jewelry Collections
                      <br/>Summer Lookbook</div>
                ...
                <div class="inner">
                  <div class="container">
                    <div class="banner-content">
                      ...
                      <h3 class="title">Save
                        <span>25%</span>Of On All
                        <br/>Items Collection</h3>
              ...
              <div class="item-banner style10">
                <div class="inner">
                  <div class="banner-content">
                    ...
                    <div class="description">We’ve been waiting for you!</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="item-banner style11">
                <div class="inner">
                  <div class="banner-content">
                    ...
                    <div class="description">A complete shopping guide on what & how to wear it!</div>
          ...
          <div class="owl-slick equal-container nav-center" data-slick='{"autoplay":false, "autoplaySpeed":1000, "arrows":false, "dots":true, "infinite":true, "speed":800, "rows":1}' data-responsive='[{"breakpoint":"2000","settings":{"slidesToShow":3}},{"breakpoint":"1200","settings":{"slidesToShow":3}},{"breakpoint":"992","settings":{"slidesToShow":2}},{"breakpoint":"768","settings":{"slidesToShow":2}},{"breakpoint":"481","settings":{"slidesToShow":1}}]'>
            <div class="stelina-blog-item equal-element layout1">
              ...
              <div class="blog-info">
                <div class="blog-meta">
                  ...
                  <span class="view">
                    <i class="icon fa fa-eye" aria-hidden="true"></i>631</span>
                  <span class="comment">
                    <i class="icon fa fa-commenting" aria-hidden="true"></i>84</span>
                </div>
                <h2 class="blog-title">
            ...
            <div class="stelina-blog-item equal-element layout1">
              ...
              <div class="blog-info">
                ...
                <div class="main-info-post">
                  <p class="des">Using Lorem Ipsum allows designers to put together layouts and the form content</p>
                  <a class="readmore" href="#">Read more</a>
                </div>
              </div>
            </div>
            <div class="stelina-blog-item equal-element layout1">
              ...
              <div class="blog-info">
                ...
                <div class="main-info-post">
                  <p class="des">Risus non porta suscipit lobortis habitasse felis, aptent interdum pretium ut.</p>
                  <a class="readmore" href="#">Read more</a>
                </div>
              </div>
            </div>
            <div class="stelina-blog-item equal-element layout1">
              ...
              <div class="blog-info">
                ...
                <div class="main-info-post">
                  <p class="des">Class integer tellus praesent at torquent cras, potenti erat fames volutpat etiam.</p>
                  <a class="readmore" href="#">Read more</a>
                </div>
              </div>
            </div>
